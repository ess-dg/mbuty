...
class pcapng_reader_fastPreAlloc():
    def __init__(self, filePathAndFileName):
        ...
        # self.timeResolution = 11.35686e-9  #s per tick ESS 
    ...
    def read(self, timeResolutionType='fine'):    
        ...
        # and the try and exept into two reads 
        ...
        print('extra len',self.totalReadoutCount-trueLen)
...
if __name__ == '__main__':
   ...
   pr = pcapng_reader_fastPreAlloc(filePath)
